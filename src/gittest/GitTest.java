...
public class GitTest {
	...
	public static void main(String[] args) throws Exception {
		...
		while (treeWalk.next()) {
			...
			System.out.println(path + ", " + treeWalk.getDepth() + ", " + treeWalk.getNameString() + ", " + treeWalk.getTreeCount());
		}
	...
	public static byte[] getData(Repository repository, String branch, String filename) throws Exception {
		ObjectId branchObjectId = repository.resolve(branch);
		if (branchObjectId == null) {
			throw new Exception("branch " + branch + " could not be resolved");
		}
